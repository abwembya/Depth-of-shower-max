...
plt.figure(dpi=100)
deg_50=np.load('deg_88.npy',allow_pickle=True)
...
plt.legend( prop={'size': 13},title='Xmax',title_fontsize=13,bbox_to_anchor=(1, 1.1), loc='upper left')
plt.xlabel('Cherenkov redii [au]',fontsize=18)
plt.ylabel('amp [$\mu$V/m]',fontsize=18)
